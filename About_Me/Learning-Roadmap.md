...
![Learning](https://img.shields.io/badge/Mindset-Lifelong%20Learner-success?style=flat-square)
![Focus](https://img.shields.io/badge/Focus-Fraud%20%2B%20Data%20%2B%20Leadership-blue?style=flat-square)

</div>

## 📋 Table of Contents
- [Philosophy on Learning](#philosophy-on-learning)
...
```mermaid
graph LR
    A[Core Fraud & Compliance Knowledge] --> B[Advanced Data & Analytics]
    B --> C[AI-Assisted Investigation Techniques]
    C --> D[Risk Strategy & Governance]
    D --> E[People & Program Leadership]

    style A fill:#30363d,color:#fff
...
- 🎓 **Certified Fraud Examiner (CFE)-track knowledge** — building toward recognized fraud examination credentials
...
⬅️ [Back: Personal-Brand.md](./Personal-Brand.md) | ➡️ [Next: Professional-Values.md](./Professional-Values.md)
