...
![Level](https://img.shields.io/badge/Level-Senior%20%2F%20Manager--Track-success?style=flat-square)
...
- [Strategic & Leadership Skills](#-strategic--leadership-skills)
...
- **Financial Crime (AML/KYC)** — customer due diligence support, suspicious activity identification, and compliance partnership
...
```mermaid
%%{init: {"themeVariables": {"pie1": "#1f6feb", "pie2": "#8A2BE2"}}}%%
pie title Skill Distribution by Category
    "Domain Expertise (Fraud & Financial Crime)" : 45
    "Technical Tools (SQL, Tableau, Apps Script, AI)" : 30
...
⬅️ [Back: Career-Journey.md](./Career-Journey.md) | ➡️ [Next: Awards.md](./Awards.md)
